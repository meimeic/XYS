...
namespace XYS.Lis.Util
{
    ...
    {
        private ReportLog m_report;

        public ReportReceivedEventArgs(ReportLog rr)
        {
            this.m_report = rr;
        }

        public ReportLog ReportReport
        {
    ...
    public class ReportLog
    {
        ...
        #region
        public ReportLog(Type source, string prefix, string message, Exception exception)
        {
        ...
        static ReportLog()
        {
            ...
            catch (Exception ex)
            {
                ...
                Error(typeof(ReportLog), "Exception while reading ConfigurationSettings. Check your .config file is well formed XML.", ex);
            }
        }
        #endregion
        ...
        public static void OnReportReceived(Type source, string prefix, string message, Exception exception)
        {
            ...
            {
                ReportReceived(null, new ReportReceivedEventArgs(new ReportLog(source, prefix, message, exception)));
            }
        }
        #endregion
