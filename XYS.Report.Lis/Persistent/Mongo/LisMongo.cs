...
namespace XYS.Report.Lis.Persistent.Mongo
{
    public class LisMongo
    {
        ...
        private static readonly string MongoDataBaseStr = "report";
        #endregion
        ...
        static LisMongo()
        {
            ...
            LisMDB = MClient.GetDatabase(MongoDataBaseStr);
        ...
        public void InsertReport(ReportReportElement report)
        {
            try
            {
                IMongoCollection<ReportReportElement> ReportCollection = LisMDB.GetCollection<ReportReportElement>("labs");
