...
namespace XYS.Report.Lis.Config
{
    public sealed class XmlConfigurator
    {
        ...
        public static XmlElement GetParamConfigurationElement(string tagName)
        {
            ...
            string configFullFile = SystemInfo.GetFileFullName(SystemInfo.ApplicationBaseDirectory, "XYS.Report.Lis.xml");
        ...
        private static void InternalConfigure(IReporterRepository repository)
        {
            ...
            catch (System.Configuration.ConfigurationException confEx)
            {
                ...
                else
                {
                    ...
                    string configSectionStr = "<section name=\"lis-report\" type=\"XYS.Report.Lis.Config.ConfigurationSectionHandler," + Assembly.GetExecutingAssembly().FullName + "\" />";
